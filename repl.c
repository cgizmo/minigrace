...
GRACELIB_PROTOTYPE(repl_registerVisitor);
GRACELIB_PROTOTYPE(repl_createobject);
GRACELIB_PROTOTYPE(repl_addmethod);
                  ...
                  Object *args, int flags)
{
    ...
    gc_unpause();
    Object ret = callmethod(replvar, "val", 0, NULL, NULL);
    gc_unpause();
    return ret;
}
...
GRACELIB_FUNCTION(repl_registerVisitor)
{
...
GRACELIB_FUNCTION(repl_createobject)
{
...
// execute the method.
GRACELIB_FUNCTION(repl_addmethod)
{
    Object o = args[0];
